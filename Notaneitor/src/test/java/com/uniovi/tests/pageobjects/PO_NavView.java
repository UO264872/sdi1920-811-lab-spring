...
public class PO_NavView extends PO_View{
	...
	* @param textOption: Texto de la opción principal.
	* @param criterio: "id" or "class" or "text" or "@attribute" or "free". Si el valor de
	criterio es free es una expresion xpath completa.
	* @param textoDestino: texto correspondiente a la búsqueda de la página destino.
	*/
	public static void clickOption(WebDriver driver, String textOption, String criterio,
	String textoDestino) {
	//CLickamos en la opción de registro y esperamos a que se cargue el enlace de Registro.
